...
[![CI](https://github.com/damien-audignon/taskops-api-m3/actions/workflows/ci.yml/badge.svg)](https://github.com/damien-audignon/taskops-api-m3/actions/workflows/ci.yml)
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=damien-audignon_taskops-api-m3&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=damien-audignon_taskops-api-m3)
...
./mvnw verify    # tests + rapport de couverture (target/site/jacoco/index.html)
```
...
3. Ouvrir une Pull Request : la fusion exige que les checks `Build & tests`, `Analyse qualite` et `SonarCloud Code Analysis` soient verts.